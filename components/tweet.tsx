    ...
    <div className="tweet rounded-lg border border-neutral-200 dark:border-neutral-800 px-6 py-4 my-4 bg-white dark:bg-neutral-900 max-w-xl mx-auto">
      ...
      <div className="flex text-sm mt-2">
        ...
        >
          ...
          <span>
            {public_metrics.reply_count ? new Number(public_metrics.reply_count).toLocaleString('en', {
              notation: 'compact',
            }) : 0}
          </span>
        </a>
        ...
        >
          ...
          <span>
            {public_metrics.retweet_count ? new Number(public_metrics.retweet_count).toLocaleString('en', {
              notation: 'compact',
            }) : 0}
          </span>
        </a>
        ...
        >
          ...
          <span>
            {public_metrics.like_count ? new Number(public_metrics.like_count).toLocaleString('en', {
              notation: 'compact',
            }) : 0}
          </span>
        </a>
