  ...
  return (
    <section>
      ...
      <p className="my-5 text-neutral-800 dark:text-neutral-200">
        ...
        Established professional with a growing background in Robotic Process Automation (RPA) development and analysis, built upon earlier experiences in Mechanical Engineering. Detail-oriented with exceptional critical thinking skills and the ability to work effectively either independently or collaboratively. Blue Prism certifications as Developer, Solution Designer, and Installation Engineer.
      </p>
